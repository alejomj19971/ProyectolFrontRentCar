...
const buscarUsuario =async()=>{
    try {
        ...
        const response = await axios.get(`https://vercel-backend-rent-car.vercel.app/api/users/buscarUsuario/${username}`);
                ...
                if(errormessage==false){
                    ...
                    // Enviar los datos
                        ...
                        try {
                            ...
                            const response = await axios.post(`https://vercel-backend-rent-car.vercel.app/api/rents/rentarcar`,datos);
                            console.log(response.data.error)
 ...
 <Controller
      ...
      {errors.username?.type === 'required' && <Text style={{color:'#f16366',marginTop:3,textAlign:'center'}} >Este Campo es Obligatorio</Text>}
       ...
       />
         ...
         name="initialdate"
       />
       {errors.initialdate?.type==="required" && <Text style={{color:'#f16366',marginTop:3,textAlign:'center'}}>Este Campo es Obligatorio</Text>}
    ...
    <Controller
       ...
       />
         ...
         name="finaldate"
       />
       {errors.finaldate?.type==="required" && <Text style={{color:'#f16366',marginTop:3,textAlign:'center'}}>Este Campo es Obligatorio</Text>}
